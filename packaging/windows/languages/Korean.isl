; Vendored from https://github.com/jrsoftware/issrc/blob/is-6_4_1/Files/Languages/Korean.isl
; Inno Setup 6.4.0+ Korean messages. License: Inno Setup License (https://jrsoftware.org/files/license.txt).
; AgentDock references this file as languages\Korean.isl together with compiler:Default.isl.
; compiler:Languages\Korean.isl is not assumed. Line endings are LF to match this repository.
